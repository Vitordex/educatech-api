...
describe('Register schema', () => {
    ...
    const schema = userSchema.schemas.register;
    ...
    describe('should throw a bad request', () => {
        ...
        it('if password is missing', async () => {
            const input = { name: 'asd', email: 'apdov@aeghio.com', birthDay: new Date(2000, 1, 1), gender: 1 };
        ...
        it('if email is in a wrong format', async () => {
            const input = { name: 'asd', email: 'apdov', password: '123456', birthDay: new Date(2000, 1, 1), gender: 1 };
